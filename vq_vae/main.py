...
from config import VQVAEModelConfig
from data.data_module import GeneExpressionDataModule
from models.vq_vae_model import VQVAELightningModel
...
trainer.fit(VQVAELightningModel(config), datamodule=GeneExpressionDataModule(config))
